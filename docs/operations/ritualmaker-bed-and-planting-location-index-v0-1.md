...
| Z7 | House-side compacted/muddy bed | Near-house compacted/muddy bed with lower seed success | Avoid relying on direct seeding; better for amended pockets/transplants |
...
| Location | Z4, all the way around the base of the big tree bed at the top of the hill slope, wrapping around to the roadside |
| Microclimate | Root-competitive tree base / upper hill edge; selection trial |
| Operational role | Flower/pantry/medicinal/pollinator; saved-seed performance test |
| Next action | Track germination under tree competition; mark as saved-seed trial |
...
| Field | Current truth |
| --- | --- |
| Status | Budding earlier; spring flower zone |
| Location | Lower mailbox/ranunculus zone and/or lower roadside spring flower zone; not the preferred new dahlia location |
| Note | Keep distinct from dahlias and upper roadside production strips |

### Peonies

| Field | Current truth |
| --- | --- |
| Status | Budding earlier |
| Location | House/rock/spring perennial contexts; exact individual bed needs field update |
...
| --- | --- |
| Cursor/agent can infer beds from generic labels like “roadside” | Must use named sub-zones: Z2, Z2A, Z2B, Z3, Z4, etc. |
| Dahlia placement is just “roadside” | Dahlias are in roadside production bed/fabric-covered strips; earlier decision favored upper roadside amended pockets over lower root-heavy mailbox zone |
...
| Big tree planting is same as roadside strip | Calendula saved seed is around big tree bed at top of hill slope, wrapping toward roadside, Z4 |
...
2. Preserve sub-zones, especially Z2A, Z2B, Z4, and Z5A.
